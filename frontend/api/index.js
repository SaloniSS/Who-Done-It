...
// Create new storage instance with Firebase project credentials
const storage = new Storage({
  projectId: "who-done-it-298503",
  keyFilename:
    "./services/who-done-it-298503-firebase-adminsdk-y119a-a1609ce38f.json",
});

// Create a bucket associated to Firebase storage bucket
const bucket = storage.bucket("gs://who-done-it-298503.appspot.com");
